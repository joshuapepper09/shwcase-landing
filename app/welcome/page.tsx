      ...
      <main style={{ minHeight: '100vh', background: '#0a0a0a', fontFamily: 'DM Sans, sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 24px', textAlign: 'center' }}>
        ...
        <style>{`
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .discord-btn:hover { background: #f0f0f0 !important; }
        `}</style>
        ...
        <div className="fade-2" style={{ marginBottom: '40px' }}>
          ...
          <p style={{ fontSize: 'clamp(16px, 2vw, 20px)', color: '#555', lineHeight: 1.6, maxWidth: '480px', margin: '0 auto' }}>
            Welcome to the founding crew. Your spot is locked in and your badge is waiting for you at launch.
          </p>
        </div>
  
        {/* What they get */}
        <div className="fade-3" style={{ width: '100%', maxWidth: '480px', marginBottom: '40px' }}>
          <div style={{ background: '#111', border: '1px solid #1a1a1a', borderRadius: '20px', padding: '28px', textAlign: 'left' }}>
            <p style={{ fontSize: '11px', color: '#444', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '20px' }}>What's coming your way</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              {[
                { icon: '✦', title: 'Founding Creator badge', desc: 'Permanent badge on your profile — forever.' },
                { icon: '⚡', title: '6 months Pro free', desc: 'Full access to Pro features from day one. No charge.' },
                { icon: '🚀', title: 'Early access on June 15', desc: 'You get in before the waitlist opens.' },
                { icon: '💬', title: 'Direct line to us', desc: 'We\'re in the Discord. Come say hi.' },
              ].map(item => (
        ...
        {/* Discord CTA */}
        <div className="fade-4" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', marginBottom: '48px' }}>
          <p style={{ fontSize: '15px', color: '#555' }}>Join our private Discord while you wait.</p>
          <a href="https://discord.gg/HH4J3fJHv" target="_blank" rel="noopener noreferrer" className="discord-btn"
